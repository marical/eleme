...
/*.good .menu-wrapper .menu-item .icon.decrease {
...
.good .menu-wrapper .menu-item .icon.discount {
...
.good .menu-wrapper .menu-item .icon.guarantee {
...
.good .menu-wrapper .menu-item .icon.invoice {
...
.good .menu-wrapper .menu-item .icon.special {
